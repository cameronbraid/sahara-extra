 ...
 */
public class AuthenticationRequestV1 extends AuthenticationRequest {

  public AuthenticationRequestV1(ApiKeyCredentials apiKeyCredentials) {
  ...
  public String toString() {
    return "AuthenticationRequestV1{" +
